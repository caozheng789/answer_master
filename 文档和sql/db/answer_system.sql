...
INSERT INTO `paperdetail` VALUES (25, 1, '西瓜皮', '可回收物', '厨余垃圾', '有害垃圾', '其他垃圾', '其他垃圾', '厨余垃圾', 1, '/2020/10/10/71de3f0f33711dedddf835b2f8ecbd9c.png', NULL);
...
INSERT INTO `paperdetail` VALUES (50, 13123, '南瓜皮', '1', '13', '123', '1', '123', '其他垃圾', 1, '/2020/10/13/36de9b807bc3abc055a60f346b3d6c06.jpg', NULL);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('adminQuartzScheduler', 'DESKTOP-GVTJOSM1602670662824', 1602670719988, 15000);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '成绩表（score）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_bullet`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '弹幕' ROW_FORMAT = Dynamic;
